...
function updateButton(option) {
    ...
    $(dropdownButton).dropdown('toggle'); // Manually close the dropdown menu
}

function saveDescription() {
    var textarea = document.getElementById("descriptionTextarea");
    description = textarea.value; // Store the value of the textarea in the description variable
}
...
$(document).ready(function() {
    ...
    $("#addBtn").click(function(a) {
        ...
        // const selectedPickerIndex = new Date(selectedDay).getDate();
